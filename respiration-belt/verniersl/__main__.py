...
class Outlet(threading.Thread):
    def __init__(self, device, enable: list = ["default"], filename: str = None):
        ...
        if filename:
            if filename.endswith(".txt"):
                ...
                self.filename = filename.split(".")[0] + ".txt"
        else:
    ...
    def run(self):
        ...
        # enable channels
        # from cmdline parameter: --enable [1,2]
        # [1,2] are Force and Respiration Belt
        device.enable_sensors(self.enable)
